...
const Landing: React.FC = ({ params }: { params: { lang: string }}) => {
  ...
  const t = translations[resolveParams.lang as 'fr' | 'en'];
    ...
    <header className={styles.header}>
      <LanguageSwitcher />
        ...
        <nav className={styles.nav}>
          ...
          <svg onClick={toggleSearch} className={styles.searchIcon} xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 50 50" width="50px" height="50px">
